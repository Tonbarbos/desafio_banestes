...
const Reports = ({ clientes, contas, onBack }) => {
  ...
  const exportToExcel = () => {
    const ws_data = [
      ...
      Object.keys(saldoData.labels),
      Object.values(saldoData.datasets[0].data),
      [],
      ['Distribuição de Limite de Crédito'],
      Object.keys(limiteCreditoData.labels),
      Object.values(limiteCreditoData.datasets[0].data),
      [],
      ['Distribuição de Crédito Disponível'],
      Object.keys(creditoDisponivelData.labels),
      Object.values(creditoDisponivelData.datasets[0].data),
      [],
      [`Distribuição de Renda Anual (Salário Mínimo: R$${SALARIO_MINIMO})`],
      Object.keys(rendaAnualData.labels),
      Object.values(rendaAnualData.datasets[0].data),
      [],
      ['Distribuição de Idade dos Clientes'],
      Object.keys(idadeData.labels),
      Object.values(idadeData.datasets[0].data),
    ];
